...
public class CreateContactWithQuickCreateContactsTestCase60 {
	public static void main(String[] args) throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		FileUtilities.openPropertyFile(IconstantPath.PROPERTYFILEPATH);
		 MsExcel.openExcel(IconstantPath.EXCELPATH);
			...
			String Excel1 = MsExcel.getDatafromExcel("Contacts", 21, 1);
	    ...
	    driver.findElement(By.xpath("//option[.='Quick Create...']")).click();
		 ...
		 driver.findElement(By.xpath("//input[@id='phone']")).sendKeys(Excel1);
			// WebElement ele2 = driver.findElement(By.xpath("//input[@id='phone']"));
